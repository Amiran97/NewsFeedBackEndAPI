...
namespace BackEnd.API.Migrations
{
    ...
    [Migration("20221223122409_AddDislike")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEnd.API.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommentUser1", b =>
                {
                    b.Property<int>("CommentDislikesId")
                        .HasColumnType("int");

                    b.Property<string>("DislikesId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("CommentDislikesId", "DislikesId");
            ...
            modelBuilder.Entity("PostUser1", b =>
                {
                    ...
                    b.Property<int>("PostDislikesId")
                        .HasColumnType("int");

                    b.HasKey("DislikesId", "PostDislikesId");

                    b.HasIndex("PostDislikesId");

                    b.ToTable("PostDislikes", (string)null);
                });

            modelBuilder.Entity("BackEnd.API.Models.Comment", b =>
                {
                    b.HasOne("BackEnd.API.Models.User", "Author")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("CommentUser", b =>
                {
                    b.HasOne("BackEnd.API.Models.Comment", null)
                        .WithMany()
                        .HasForeignKey("CommentLikesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BackEnd.API.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CommentUser1", b =>
                {
                    b.HasOne("BackEnd.API.Models.Comment", null)
                        .WithMany()
                        .HasForeignKey("CommentDislikesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PostTag", b =>
                {
                    b.HasOne("BackEnd.API.Models.Post", null)
                        .WithMany()
                        .HasForeignKey("PostsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BackEnd.API.Models.Tag", null)
                        .WithMany()
